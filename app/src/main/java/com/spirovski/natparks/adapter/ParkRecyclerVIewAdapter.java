...
public class ParkRecyclerVIewAdapter extends RecyclerView.Adapter<ParkRecyclerVIewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(com.spirovski.natparks.R.layout.park_row, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            parkImage = itemView.findViewById(com.spirovski.natparks.R.id.row_park_imageview);
            parkName = itemView.findViewById(com.spirovski.natparks.R.id.row_park_name_textview);
            parkType = itemView.findViewById(com.spirovski.natparks.R.id.row_park_type_textview);
            parkState = itemView.findViewById(com.spirovski.natparks.R.id.row_park_state_textview);
